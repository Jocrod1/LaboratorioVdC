...
namespace Metodos
{
    ...
    {
        public static string Insertar(int ID, string nombre, string unidades, double valor_Hombre, double valor_Mujer, double precio1, double precio2, string plazo_entrega, string observacion, int iD_Grupo_Examen, int titulo, int lab_Referencia, int precio_Referencia)
        {
        ...
        public static string Editar(int ID, string nombre, string unidades, double valor_Hombre, double valor_Mujer, double precio1, double precio2, string plazo_entrega, string observacion, int iD_Grupo_Examen, int titulo, int lab_Referencia, int precio_Referencia)
        {
            DExamen Objeto = new DExamen();
            Objeto.ID = ID;
            Objeto.Nombre = nombre;
