...
namespace Interfaz
{
    public partial class GrupoExamen : Form
    {
        ...
        private void OcultarColumnas()
        {
            ...
            this.dataListado.Columns[1].HeaderText = "Nombre del Grupo de Examenes";
        }
        ...
        private void EliminarItems()
        {
            ...
            try
            {
                ...
                {
                    Opcion = MessageBox.Show("¿Realmente desea eliminar los " + NumeroSeleccionado + " registros de Grupo de Examenes?", "Laboratorio Clínico Virgen de Coromoto", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
                }
                else
                {
                    Opcion = MessageBox.Show("¿Realmente desea eliminar el registro del Grupo de Examenes?", "Laboratorio Clínico Virgen de Coromoto", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
                }
                ...
                if (Opcion == DialogResult.OK)
                {
                    ...
                    foreach (DataGridViewRow item in this.dataListado.SelectedRows)
                    {
                        Rpta = MGrupoExamen.Eliminar(Convert.ToInt32(item.Cells["ID"].Value));
                    }
                    ...
                    if (Rpta.Equals("OK"))
                    {
                        if (NumeroSeleccionado > 1)
                        {
                            this.MensajeOK("Se eliminaron correctamente los registros de Grupos de Examenes");
                        }
                        else
                        {
